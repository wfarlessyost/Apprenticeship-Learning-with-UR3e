...
if("TRUE" STREQUAL "TRUE")
  set(moveit_experimental_SOURCE_PREFIX /home/will/ur3_ws/src/moveit/moveit_experimental)
  set(moveit_experimental_DEVEL_PREFIX /home/will/ur3_ws/devel)
  ...
  set(moveit_experimental_INSTALL_PREFIX /home/will/ur3_ws/install)
...
if(NOT "/home/will/ur3_ws/devel/include;/home/will/ur3_ws/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(moveit_experimental_INCLUDE_DIRS "")
  set(_include_dirs "/home/will/ur3_ws/devel/include;/home/will/ur3_ws/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/will/ur3_ws/src/moveit/moveit_experimental/${idir}'.  ${_report}")
    endif()
