...
public:
    ...
    void setupUi(QWidget *MotionPlanningUI)
    {
        ...
        sizePolicy3.setHeightForWidth(query_stackedwidget->sizePolicy().hasHeightForWidth());
        query_stackedwidget->setSizePolicy(sizePolicy3);
        ...
        query_stackedwidgetPage2->setGeometry(QRect(0, 0, 109, 82));
        ...
        sizePolicy3.setHeightForWidth(use_start_state_button->sizePolicy().hasHeightForWidth());
        use_start_state_button->setSizePolicy(sizePolicy3);
        ...
        query_stackedwidgetPage1->setGeometry(QRect(0, 0, 225, 82));
        ...
        sizePolicy3.setHeightForWidth(use_goal_state_button->sizePolicy().hasHeightForWidth());
        use_goal_state_button->setSizePolicy(sizePolicy3);
        ...
        gridLayout_6->addWidget(clear_octomap_button, 2, 0, 1, 1);
        ...
        QWidget::setTabOrder(use_goal_state_button, planning_time);
        ...
        QWidget::setTabOrder(allow_external_program, goal_tolerance);
        QWidget::setTabOrder(goal_tolerance, detected_objects_list);
